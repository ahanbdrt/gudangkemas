...
class Keluar_model extends CI_Model{
    public function getkeluar(){
        $this->db->select("master.kode,master.nama,grup.namagrup,grup.namasubgr,riwayat.noform,riwayat.tglform,riwayat.keluar,riwayat.suplai,riwayat.cat,riwayat.tgltrima")
